...
// Revision: 0.02 - Modified by Matthew Wong to only filter bounce, will hold
////////////////////////////////////////////////////////////////////////////////

module debounce_hold(
    input CLK,
    input BTN,
    output logic DB_BTN
    );
    ...
    const logic [7:0] c_HIGH_GOING_LOW_CLOCKS = 8'h50; // 50 clks
    ...
    always_comb begin
        ...
        case (PS)
            ...
            NS = ST_init;
             ...
             // button press complete, create a single pulse
